...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
     ...
     * @param inflater The inflater for this ListActivity
     */
    public FirebaseListAdapter(Query ref, Class<T> modelClass, int layout, LayoutInflater inflater) {
        this.ref = ref;
